...
**Status: DRAFT.** To lock: review, commit, copy to
`tier1_preregistration_v3_olmo2_1b.LOCKED.md`, tag
`tier1_prereg_v3_locked`, hash recorded in `tier1_olmo_verdict.json`.
...
*Draft 2026-04-26. To lock: review, edit `<commit-hash-after-lock>`,
copy to `…LOCKED.md`, tag `tier1_prereg_v3_locked`. One-shot. No rescue.*
