...
Frozen copy of v2 draft at the moment of approval. The draft file may
evolve in the future; *this* file does not. Any substantive change is
a pre-registration violation.

Tag: `tier1_prereg_v2_locked`. Hash recorded in `trajectory_verdict.json`
of every Phase 3 run.
...
*Locked 2026-04-26. Tag `tier1_prereg_v2_locked`. One-shot. No rescue.*
