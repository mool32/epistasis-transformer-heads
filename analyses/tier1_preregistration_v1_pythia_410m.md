...
**Status: DRAFT v2.** To lock: replace `<TBD>` placeholders, commit, copy
this file to `tier1_preregistration_v1_pythia_410m.LOCKED.md`, record
commit hash both at the head of this file and inside `tier1_verdict.json`.
...
*Draft v2, 2026-04-25. To lock: replace `<TBD>` with the eval-cache
hash, commit this file, copy to `…LOCKED.md`, record locked commit
hash in this header and in `tier1_verdict.json`. One-shot. No rescue.*
